...
from wtforms import StringField, PasswordField, TextAreaField, BooleanField, FileField, DateField, SelectField
from wtforms.validators import DataRequired, Email, Length, InputRequired, Optional, Required, url

class SignupForm(FlaskForm):
    """Form to create a new user"""

    username = StringField('Username', validators=[DataRequired(), Length(min=4, message="Username must be at least 4 characters.")])
